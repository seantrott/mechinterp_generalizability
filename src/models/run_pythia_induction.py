"""
Induction head detection across the main Pythia suite (no random seeds).
...
Usage:
    python run_induction_scores_pythia_main.py
"""
    ...
    for mpath in MODELS:
        for checkpoint in tqdm(revisions, desc=mpath):
            ...
            df = scores_to_dataframe(
                ...
                config, mpath, checkpoint, n_params
            )
